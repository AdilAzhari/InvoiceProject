								...
								<div class="pl-0">
									<div class="main-profile-overview">
										<div class="main-img-user profile-user">
											<img alt="" src="{{URL::asset('assets/img/faces/11.jpg')}}"><a class="fas fa-camera profile-edit" href="JavaScript:void(0);"></a>
										</div>
									...
									<div class="tab-pane" id="settings">
										<form role="form">
											...
											<div class="form-group">
												...
												<input type="text" value="{{ Auth::user()->name }}" id="Username" class="form-control">
											</div>
											<div class="form-group">
